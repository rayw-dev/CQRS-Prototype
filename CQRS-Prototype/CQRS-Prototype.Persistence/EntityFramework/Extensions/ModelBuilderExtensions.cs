...
namespace CQRS_Prototype.Persistence.EntityFramework.Extensions
{
    public static class ModelBuilderExtensions
    {
        public static void ApplyAllConfigurations<T>(this ModelBuilder modelBuilder) where T : DbContext
        {
